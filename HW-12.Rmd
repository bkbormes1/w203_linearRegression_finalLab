...
> 1. **IID Data:** 'The data is not IID. It was collected by pulling videos that are in the top 20 related videos queue of any of the videos analyzed prior. This means that the video data is not independent because the videos aren't sampled at random. They're all related by topic. The response I'll take to this is to acknowledge that my data set isn't completely IID and my findings are specific for videos related to the topic or theme that all videos shared.'
...
> 3. **Linear Conditional Expectation:** 'To assess whether there is a linear conditional expectation, we've learned to look at the predicted vs. residuals of the model. We are expecting to see the plot be linear. 
Also include what you observe in your plot. In the model that you have chosen to report, do you satisfy the assumption of a linear conditional expectation? 
